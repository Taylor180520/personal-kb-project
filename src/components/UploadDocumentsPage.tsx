      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="flex items-center mb-12">
          <div className="flex items-center">
            ...
            <span className="ml-3 text-green-400 font-medium">Contributor Info</span>
          </div>
          <div className="flex-1 h-1 bg-gray-700 mx-8 rounded-full">
          ...
          <div className="flex items-center">
            ...
            <span className="ml-3 text-green-400 font-medium">Document Details</span>
          </div>
        </div>
        ...
        <div className="bg-gray-900 rounded-xl p-8 border border-gray-700">
          ...
          {currentStep === 1 && (
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-medium text-white mb-6">Contributor Information</h3>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:border-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-600/20"
          ...
          {currentStep === 2 && (
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-medium text-white mb-6">Document Details</h3>
              </div>
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-600 rounded-xl p-12 text-center hover:border-gray-500 transition-colors">
                  ...
                  <p className="text-gray-300 mb-3 text-lg">
                    <span className="text-green-400 font-medium">Choose One/Multiple</span> or drag and drop them here
                  </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white focus:border-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-600/20"
                  >
              ...
              <div className="flex justify-between pt-6">
                <button
                  onClick={handleBack}
                  className="px-6 py-3 border border-gray-600 text-gray-300 hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-2"
                >
                  <ArrowLeft size={18} />
